...
% (christoffel_symbolicallyGenerated5DOF.m) for the optimized symbolic
% equations
% (christoffel_symbolicallyGenerated5DOFnoOptimization.m) for the 
...
for temp=1:iterations
    y = christoffel_symbolicallyGenerated5DOF(q(1),q(2),q(3),q(4),q(5));
    index=0;
    for i=1:n
        for j=1:n
            for k=1:j
...
y = christoffel_symbolicallyGenerated5DOFnoOptimization(q(1),q(2),q(3),q(4),q(5));
index=0;
for i=1:n
    for j=1:n
        for k=1:j
